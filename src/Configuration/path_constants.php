...
define('__LAYOUT_URL_PATH__', __LAYOUT_ROOT__.\DIRECTORY_SEPARATOR.'themes');
define('__THEME_DIR__', __CWP_SOURCE__.\DIRECTORY_SEPARATOR.'Templates'.\DIRECTORY_SEPARATOR.'themes');
